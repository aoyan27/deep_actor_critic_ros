...
class agent:
    ...
    filename_critic_model = "/home/amsl/ros_catkin_ws/src/deep_actor_critic/actor_critic_for_swingup/test_results/models/myrrbot_critic_model.dat"
    filename_actor_model = "/home/amsl/ros_catkin_ws/src/deep_actor_critic/actor_critic_for_swingup/test_results/models/myrrbot_actor_model.dat"

    filename_result = "/home/amsl/ros_catkin_ws/src/deep_actor_critic/actor_critic_for_swingup/test_results/results/myrrbot_result.txt"
    ...
    def reset_client(self, angle):
        ...
        request = LinkState()
        request.link_name = "myrrbot::link2"
    ...
    def V_func(self, s):
        ...
        #  print "h1 : ", h1.data
        #  output_data = self.critic_model.l1(input_data)
        input_data = chainer.Variable(s)
        h1 = F.relu(self.critic_model.l1(input_data))
    ...
    def critic_forward(self, s, r, next_s, episode_end):
        ...
        loss = F.mean_squared_error(chainer.Variable(target), V)
        #  print "loss : ", loss.data
    ...
    def actor_func(self, s):
        ...
        #  print "h1 : ", h1.data
        #  output_data = self.actor_model.l1(input_data)
        input_data = chainer.Variable(s)
        h1 = F.relu(self.actor_model.l1(input_data))
    ...
    def actor_forward(self, s):
        ...
        #  print "act(actor_forward) : ", act.data
        target = xp.array([[self.oldact]], dtype=xp.float32)
        #  print "target(actor_forward) : ", target
        ...
        loss = F.mean_squared_error(chainer.Variable(target), act)
        #  print "loss(actor) : ", loss.data
        
        
        #  print "self.actor_model.gradients(before) : ", self.actor_model.gradients
        loss.backward()
        #  print "self.actor_model.gradients(after) : ", self.actor_model.gradients

        #  print "self.actor_model.parameters(before) : ", self.actor_model.parameters
        self.actor_optimizer.update()
        #  print "self.actor_model.parameters(after) : ", self.actor_model.parameters
        return error, act
    ...
    def main(self, limit_episode, limit_step):
        rospy.init_node('deep_actor_critic_for_swingup_myrrbot')

        rospy.Subscriber("/joint_effort", Float64, self.effort_callback)

        pub = rospy.Publisher("/myrrbot/joint1_controller/command", Float64, queue_size = 1)
